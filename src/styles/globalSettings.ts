...
import lightBackgroundDesktop from '../assets/images/pattern-background-desktop-light.svg';
import darkBackgroundDesktop from '../assets/images/pattern-background-desktop-dark.svg';
import lightBackgroundTablet from '../assets/images/pattern-background-tablet-light.svg';
import darkBackgroundTablet from '../assets/images/pattern-background-tablet-dark.svg';
import lightBackgroundMobile from '../assets/images/pattern-background-mobile-light.svg';
import darkBackgroundMobile from '../assets/images/pattern-background-mobile-dark.svg';
...
@font-face {
  ...
  * {
  ...
  body {
    ...
    background: ${({ darkMode }) =>
      darkMode
        ? `url(${darkBackgroundDesktop})`
        : `url(${lightBackgroundDesktop})`} 
    ...
    @media screen and (max-width: ${({ theme }) => theme.size.tablet}){
     background: ${({ darkMode }) =>
       darkMode
         ? `url(${darkBackgroundTablet})`
         : `url(${lightBackgroundTablet})`}
